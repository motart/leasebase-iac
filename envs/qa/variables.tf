...
variable "web_container_image" {
  description = "Container image for the QA web frontend."
  type        = string
}
...
variable "web_desired_count" {
  description = "Desired task count for the QA web service."
  type        = number
  default     = 2
}
...
variable "create_dns_record" {
  description = "Whether to create Route 53 DNS record for QA subdomain."
  type        = bool
  default     = true
}
